...
MAX_OTP_ATTEMPTS = 5
MAX_OTP_REQUESTS_EMAIL_15MIN = 15 if not IS_PRODUCTION else 5
MAX_OTP_REQUESTS_IP_15MIN = 30 if not IS_PRODUCTION else 10
OTP_COOLDOWN_SECONDS = 30 if not IS_PRODUCTION else 180
